...
import com.smile.mypark.data.mapper.toDto
...
class SignRepositoryImpl(
    ...
    override suspend fun register(info: RegisterInfo) {
        val res = service.register(info.toDto())
        res.requireSuccessOrThrow("회원가입 실패")
    }
}
